...
{
    class FrostyDrecko : IEntityConfig
    {
        ...
        public static string Name = UI.FormatAsLink("Frosty Drecko", ID);
        public const string Description = "It grows pieces of rare materials on its back from the plants it eats.";
        public static string EggName = UI.FormatAsLink("Frosty Drecklet Egg", EGG_ID);
        public const string BabyId = "FrostyDrecklet";
        public static string BabyName = UI.FormatAsLink("Frosty Drecklet", BabyId);
        public const string BabyDescription = "It grows soft and small pieces of rare materials on its back.";
        ...
        public static Tag POOP_ELEMENT = SimHashes.Isoresin.CreateTag();
        public static Tag EMIT_ELEMENT = SimHashes.Fullerene.CreateTag();
        private static float DAYS_PLANT_GROWTH_EATEN_PER_CYCLE = 3f;
        private static float CALORIES_PER_DAY_OF_PLANT_EATEN = DreckoTuning.STANDARD_CALORIES_PER_CYCLE / FrostyDrecko.DAYS_PLANT_GROWTH_EATEN_PER_CYCLE;
        private static float KG_POOP_PER_DAY_OF_PLANT = 3f;
        private static float MIN_POOP_SIZE_IN_KG = 1.5f;
        private static float MIN_POOP_SIZE_IN_CALORIES = FrostyDrecko.CALORIES_PER_DAY_OF_PLANT_EATEN * FrostyDrecko.MIN_POOP_SIZE_IN_KG / FrostyDrecko.KG_POOP_PER_DAY_OF_PLANT;
        public static float SCALE_GROWTH_TIME_IN_CYCLES = 3f;
        public static float FIBER_PER_CYCLE = 50f/1000;
        public static int EGG_SORT_ORDER = 1;
        public const string ID = "DreckoFrosty";
        public const string BASE_TRAIT_ID = "DreckoFrostyTrait";
        public const string EGG_ID = "DreckoFrostyEgg";
  ...
  bool is_baby)
        {
            GameObject wildCreature = EntityTemplates.ExtendEntityToWildCreature(BaseDreckoConfig.BaseDrecko(id, name, desc, anim_file, BASE_TRAIT_ID, is_baby, (string)null, 308.15f-60, 363.15f-90), DreckoTuning.PEN_SIZE_PER_CREATURE);
            CreateTrait(name);
            ...
            Diet diet = new Diet(new Diet.Info[1]
    {
      ...
      {
      (Tag)ColdWheatConfig.ID, (Tag)BeanPlantConfig.ID
      }, FrostyDrecko.POOP_ELEMENT, FrostyDrecko.CALORIES_PER_DAY_OF_PLANT_EATEN, FrostyDrecko.KG_POOP_PER_DAY_OF_PLANT, (string) null, 0.0f, false, true)
    });
            CreatureCalorieMonitor.Def def1 = wildCreature.AddOrGetDef<CreatureCalorieMonitor.Def>();
            def1.diet = diet;
            def1.minPoopSizeInCalories = FrostyDrecko.MIN_POOP_SIZE_IN_CALORIES;
            ...
            def2.defaultGrowthRate = (float)(1.0 / (double)FrostyDrecko.SCALE_GROWTH_TIME_IN_CYCLES / 600.0);
            def2.dropMass = FrostyDrecko.FIBER_PER_CYCLE * FrostyDrecko.SCALE_GROWTH_TIME_IN_CYCLES;
            def2.itemDroppedOnShear = FrostyDrecko.EMIT_ELEMENT;
            def2.levelCount = 6;
        ...
        public GameObject CreatePrefab()
        {
            ComplexRecipe.RecipeElement[] ingredients = new ComplexRecipe.RecipeElement[4]
           {
                ...
                new ComplexRecipe.RecipeElement(SimHashes.Ice.CreateTag(), 5000f),
                new ComplexRecipe.RecipeElement(SimHashes.LiquidOxygen.CreateTag(), 1000f),
           };
            ...
            return EntityTemplates.ExtendEntityToFertileCreature(
             CreateCritter(
                 ...
                 desc: Description,
                 anim_file:
                 "adult_snow_drecko_kanim",
                 is_baby: false
             ),
             EGG_ID,
             EggName,
             Description,
             "egg_snow_drecko_kanim",

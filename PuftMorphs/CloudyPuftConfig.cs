...
namespace PuftMorphs
{
    public class CloudyPuftConfig : IEntityConfig
    {
        ...
        public static string EggName = UI.FormatAsLink("Cloudy Puftlet Egg", EGG_ID);
        ...
        public const float warningLowTemperature = 0;
        public const float warningHighTemperature = 303.15f;//273.15f;
      ...
      bool is_baby)
        {
            ...
            GameObject go = BasePuftConfig.SetupDiet(wildCreature, SimHashes.Hydrogen.CreateTag(), SimHashes.LiquidHydrogen.CreateTag(), CloudyPuftConfig.CALORIES_PER_KG_OF_ORE, TUNING.CREATURES.CONVERSION_EFFICIENCY.GOOD_2, (string)null, 0.0f, CloudyPuftConfig.MIN_POOP_SIZE_IN_KG);

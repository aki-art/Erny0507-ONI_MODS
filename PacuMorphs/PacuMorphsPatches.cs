    ...
    public class PacuMorphsPatches : KMod.UserMod2
    {
        ...
        public class EntityConfigManager_LoadGeneratedEntities_Patch
        {
            public static void Prefix()
            {
                ...
                Strings.Add($"STRINGS.CODEX.PACUBETA.TITLE", "Beta Pacu");
        ...
        public class ModifierSet_LoadFertilityModifiers_Patch
        {
            ...
            { 
                ...
                var CreateModifier = Traverse.Create(typeof(TUNING.CREATURES.EGG_CHANCE_MODIFIERS)).Method("CreateTemperatureModifier",
                    new[] { typeof(string), typeof(Tag), typeof(float), typeof(float), typeof(float), typeof(bool) });

...
namespace PacuMorphs
{
    public class AlgaePacuConfig : IEntityConfig
    {
        ...
        public static string DESCRIPTION = "Its fins are full with algae which helps its digestion.";
        public static string EGG_NAME = UI.FormatAsLink("Kelp Fry Egg", ID.ToUpper());

        public const float MIN_TEMP = 333.15f-15f;
        ...
        public GameObject CreatePrefab()
        {
            ComplexRecipe.RecipeElement[] ingredients = new ComplexRecipe.RecipeElement[4]
          {
                ...
                new ComplexRecipe.RecipeElement(SimHashes.Algae.CreateTag(), 1000f),
          };
